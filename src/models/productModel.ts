...
// /** NEW: describes what makes a variant different (size, weight, shade, etc.) */
// interface IVariantMeasurement {
//   value?: number; // 200, 500, 1 ...
//   unit?: string; // "ml", "L", "g", "kg", "pcs"
//   label?: string; // "200 ml", "1 L", "Shade 01", "Combo Pack"
// }

// interface IVariant {
//   _id: Types.ObjectId; // your id
//   packOf: number; // packof (1,2,3...)
//   measurement?: IVariantMeasurement; // NEW – optional per-variant quantity/label
//   mrp: number; // MRP
//   sellingPrices: IPriceTier[]; // Selling Price[]
//   images: IImage[]; // image[]
//   isActive: boolean;
//   stock: number; // Stock
// }
...
// /** NEW: embedded measurement for each variant */
// const VariantMeasurementSchema = new Schema<IVariantMeasurement>(
//   {
//     value: { type: Number, min: 0 }, // 200, 500, 1 ...
//     unit: { type: String, trim: true }, // "ml", "L", "g", "pcs"
//     label: { type: String, trim: true }, // "200 ml", "Shade 01", "Combo Pack"
...
//     // NEW: optional measurement info
//     measurement: {
//       type: VariantMeasurementSchema,
//       default: undefined, // omit field when not used (e.g. pack-only lipstick)
//     },
...
//     // thumbnail uses the same rich image schema
...
// // NEW: index to query by quantity/size (e.g. 500 ml, 1 L)
// ProductSchema.index(
//   {
